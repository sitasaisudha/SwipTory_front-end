...
}; // to show the success toast message
...
const showToastREgisterSuccessMessage = () => {
  ...
  return (
    ...
    <p className="float-into-icon" onClick={()=>setText(false)}> <i className="ri-close-circle-line"  ></i>  </p>
            ...
            <div>
              <p className="para">
                ...
                <input
                  ...
                  onClick={() => {setRegister(false) ;setMsg("Login to SwipTory")  }}
                />
              </p>
              <input type="button" className="form-button" value="Register" onClick={(e)=> handleSubmit(e)} />
            </div>
          )}
          {!register && (
            <div>
              <p className="para">
                ...
                <input
                  ...
                  value="Sign Up"
                  className="link-button"
                  onClick={() => {setRegister(true) ;setMsg("Login to SwipTory")}}
                />
              </p>
              <input type="button" className="form-button"  value="Sign In" onClick={(e)=>{;handleSubmit(e)}} />
            </div>
          )}
