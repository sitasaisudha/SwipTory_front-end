   ...
   if(!name){
    ...
    try {
      ...
      if (isCurrentlyBookmarked) {
        const updatedBookmarkedSlides = bookmarkedSlides.filter(id => id !== slideId);
          ...
          <div key={slide.id} className="mod-slide-wrapper">
            ...
            <div className="slide-content">
              ...
              <div className="bkmk-lk">
                 ...
                 <button onClick={() => handleBookmarkToggle(slide._id)} className={`bookmark-button ${bookmarkedSlides.includes(slide._id) ? 'filled' : 'fill'}`} >
            

                  <i
                    className={`ri-bookmark-${ bookmarkedSlides.includes(slide._id)? "fill" : "line"}`}
                  ></i>
            </button>
