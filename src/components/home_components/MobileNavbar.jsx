    ...
    return (
        <div>
             <div className="navbar">
                <span>SwipTory</span>
                <i className="ri-menu-line" onClick={() => { setShowMobile(true) }} ></i>
            </div>

            {showMobile && !isLogIn ? <div className="mobile-show-buttons">
                <div className="mobile-into" onClick={() => { setShowMobile(false) }}>x</div>
                <button className="loggedin-register-button" onClick={()=>{setRegister(false) ; setText(true);setMsg("Login to SwipTory")}}>Register</button><br></br>
                <button className="loggedin-register-button" onClick={()=>{setRegister(true) ; setText(true);setMsg("Register to SwipTory")}}>Login</button>
            </div> : ""}
            ...
            {showMobile && isLogIn ? <div className="mobile-show-buttons">
                ...
                <button className="loggedin-register-button" >
                    Your Story
                </button><br></br>
                <button className="loggedin-register-button" onClick={()=>{logoutHeader() ; handelAddStory() } }>
                    Add Story
                </button><br></br>
                <button className="loggedin-register-button" >
                    Bookmarks
